; This script is modified from the KDE style window dragging included in AutoHotKey's
; script showcase found here: https://www.autohotkey.com/docs/v2/scripts/index.htm#EasyWindowDrag_(KDE)
; It's been modified to use Capslock rather than LAlt for it's keybinds as well
; as commenting out the double-tap detection
...
;~CapsLock::
;{
;    global g_DoubleAlt := (A_PriorHotkey = "~CapsLock" and A_TimeSincePriorHotkey < 400)
;    Sleep 0
